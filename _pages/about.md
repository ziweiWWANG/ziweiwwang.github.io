...
- Congrats to Zun Wang, An dong and Team for winning the Room-Across-Room (RxR) Habitat Challenge 2022!!! :laughing::zap: <a target="_blank" href="https://arxiv.org/abs/2206.11610"><button id="touch">PDF</button></a> <a target="_blank" href="[https://github.com/YicongHong/Discrete-Continuous-VLN](https://drive.google.com/file/d/15VbXcanw7D3q5TUm75WmDVslqgOmVvJk/view?usp=sharing)"><button id="touch">Code</button></a>
